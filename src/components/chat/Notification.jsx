    ...
    return ( 
        <div className="notifications" onClick={() => setIsOpen(!isOpen)}>
            <div className="notifications-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="currentColor" class="bi bi-chat-left-fill" viewBox="0 0 16 16">
            ...
            {isOpen && (<div className="notifications-box">
                ...
                {modifiedNotifications && modifiedNotifications.map((n, index) => {
                    return (<div
                        key={index}
                        className={n.isRead ? 'notificaton' : 'notification not-read'}
                        onClick={() => {
